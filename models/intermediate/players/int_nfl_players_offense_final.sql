...
SELECT
    ...
    -- Stats RB
    rush.rush_yrds_per_game + receiving_yrds_per_game AS rb_tot_yards_per_game,
    rush.rush_succ_perc AS rb_rsh_succ_perc,
    rush.rush_yards_before_contact_per_attmpt AS rb_rsh_yrds_bfr_contact_per_attmpt,
    rush.rush_yards_after_contact_per_attmpt AS rb_rsh_yrds_aftr_contact_per_attmpt, 
    rush.rush_yrds_per_attmpt AS rb_rsh_yrds_per_attmpt,
    rush.rush_yrds_per_game AS rb_rsh_yrds_per_game
FROM union_table
