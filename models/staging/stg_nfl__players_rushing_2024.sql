...
END as team,
        ...
        rushing_succ_,
        rushing_lng,
        YBC_A AS rushing_yards_before_contact_per_attempt,
        YAC_A AS rushing_yards_after_contact_per_attempt, 
        rushing_y_a AS rushing_yards_per_attempts,
        rushing_y_g AS rushing_yards_per_game,
        rushing_a_g,
        fmb,
        awards,
        player_pk
